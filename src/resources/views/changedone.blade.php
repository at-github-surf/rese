...
@section('title')
<title>予約変更完了 | rese</title>
@endsection

@section('css')
<link rel="stylesheet" href="{{ asset('css/changedone.css') }}">
@endsection
    ...
    <div class="dialog__wrapper">
        <div class="dialog__outer">
            <div class="dialog__inner">
                <span class="dialog__message">ご予約の変更を完了しました</span>
                <div class="dialog__return"><a href="/mypage" class="dialog__return-label">マイページに戻る</a></div>
